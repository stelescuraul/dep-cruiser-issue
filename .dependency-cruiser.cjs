...
module.exports = {
  forbidden: [
    ...
    {
      name: "no-import-module-from-outside",
      comment: "should not import from outside modules",
      severity: "error",
      to: { pathNot: ["^libs/*", "^node_modules"] },
      from: { path: "^libs/([^/]+)/.*" },
    },
    {
      name: "no-circular",
...
// generated: dependency-cruiser@15.3.0 on 2023-11-14T10:55:31.542Z
